...
6,511 KartaView), while the final frozen v4 production gallery/index contains
20,487 references (14,099 Mapillary; 6,388 KartaView). This is an engineering
...
| SAGE code and ViT-B checkpoint | [`chenshunpeng/SAGE`](https://github.com/chenshunpeng/SAGE) at `c7d6241c4885526d99d6c78c158024fc2a37097c`; [`shunpeng/SAGE`](https://huggingface.co/shunpeng/SAGE) at `2a2ea9964cdbdfd2211e7c625064a9d5e4678245`, checkpoint SHA-256 `8cfed7d4e8bbcdee4c016b29211f64ffd015c3cbae538034b3352c858af6a27e` | Official repository and model card state MIT | Final production retriever. Preserve MIT notice and recheck terms before deployment/redistribution; this is a technical audit, not legal advice. |
